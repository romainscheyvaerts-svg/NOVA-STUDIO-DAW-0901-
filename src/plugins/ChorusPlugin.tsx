...
export class ChorusNode {
  ...
  private setupGraph() {
    ...
    // Connect splitter outputs to delays (CORRECTED)
    this.splitter.connect(this.delayL, 0);  // Left channel -> left delay
    this.splitter.connect(this.delayR, 1);  // Right channel -> right delay

    // Left channel LFO -> delay
    this.lfoL.connect(this.depthL);
    this.depthL.connect(this.delayL.delayTime);
    this.delayL.connect(this.merger, 0, 0);
    
    // Right channel LFO -> delay
